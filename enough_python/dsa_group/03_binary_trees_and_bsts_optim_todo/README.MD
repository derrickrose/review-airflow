...
PREORDER traversal when visiting node first then left and right
INORDER traversal when visiting left then node and right
POSTORDER traversal when visiting left then right and node
