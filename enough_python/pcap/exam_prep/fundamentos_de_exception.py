...
## UnboundLocalError
### BaseExceptoin <- Exception <- NameError <- UnboundLocalError
### exception concreta que surge (dentro de una funcion) cuando se intenta acceder a un variable fuera de su alcance
### NameError cuando tiene misma espacio de trabajo
...
## nota la existencia del atributo args
## pero ojo con args, solo guarda los argumentos pasado en el BaseException que por ahora es solo message
