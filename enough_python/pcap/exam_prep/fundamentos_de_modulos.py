...
## cada modulo consta de entidades (como libro consta de capitulos)
...
## la function dir() muestra todas las entidades en orden alfabeticamente de un modulo
print(dir(math))
## la funcion help() muestra la documenation de un modulo
help(math)
