# caracteres y cadena
## las compu almacenan los caracteres como numeros (cada caracter equivalente a un numero y vice versa)
...
## se puede establecer la mitad superior de los puntos de codigo de manera diferente para diferentes idiomas ?
...
## (un ejemplo de implementacion de unicode ya que unicode no menciona como almacenar tampoco codificar los caracteres)
...
# utf-8 unicode transformation format (otra implementacion de unicode)
## el mas utilizado
...
# resumen
## punto de codigo ej. 32
## paginas de codigo ej. pagina para frances
